...
public struct HoudiniVersion
{
	...
	public const int ORIG_HOUDINI_BUILD		= 565;
	...
	public const string HAPI_LIBRARY		= "/Library/Frameworks/Houdini.framework/Versions/13.0.565/Houdini";
#else
	public const string HAPI_LIBRARY		= "";
#endif
};
