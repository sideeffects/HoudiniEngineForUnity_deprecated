...
public struct HoudiniVersion
{
	...
	public const string HAPI_SERVER			= "/Applications/Houdini/16.0.317/Frameworks/Houdini.framework/Versions/Current/Resources/bin" + "HARS";
	#if UNITY_EDITOR_64
		public const string HAPI_LIBRARY	= "/Applications/Houdini/16.0.317/Frameworks/Houdini.framework/Versions/Current/Libraries" + "libHARC.dylib";
	#else
		public const string HAPI_LIBRARY	= "/Applications/Houdini/16.0.317/Frameworks/Houdini.framework/Versions/Current/Libraries" + "libHARC32.dylib";
	#endif // UNITY_EDITOR_64

#elif UNITY_STANDALONE_LINUX

	public const string HAPI_SERVER			= "/opt/hfs16.0.317/dsolib/" + "HARS";
	public const string HAPI_LIBRARY		= "/opt/hfs16.0.317/bin/" + "libHARC.so";
