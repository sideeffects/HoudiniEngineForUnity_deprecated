...
public struct HoudiniVersion
{
	...
	public const int HOUDINI_BUILD			= 593;
	...
	public const string HAPI_SERVER			= "/Applications/Houdini/Houdini16.0.593/Frameworks/Houdini.framework/Versions/16.0.593/Resources/bin/" + "HARS";
	#if UNITY_EDITOR_64 || UNITY_64
		public const string HAPI_LIBRARY	= "/Applications/Houdini/Houdini16.0.593/Frameworks/Houdini.framework/Versions/16.0.593/Libraries/" + "libHARC.dylib";
	#else
		public const string HAPI_LIBRARY	= "/Applications/Houdini/Houdini16.0.593/Frameworks/Houdini.framework/Versions/16.0.593/Libraries/" + "libHARC32.dylib";
	#endif // UNITY_EDITOR_64

#elif UNITY_STANDALONE_LINUX

	public const string HAPI_SERVER			= "/opt/hfs16.0.593/dsolib/" + "HARS";
	public const string HAPI_LIBRARY		= "/opt/hfs16.0.593/bin/" + "libHARC.so";
